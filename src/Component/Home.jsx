        ...
        <div className="container">
            <div className="left">
             ...
             <button className="btn" onClick={contact}>Contact</button>
                      <button className="btn"><a target="blank" href="https://drive.google.com/file/d/1ZQOyfvWfIRBGdWDNMn0ofTVzc-ijmqBy/view?usp=sharing">Resume</a></button>
             </div>
             <div className="right">
         ...
         <footer class="footer">
            ...
            <div class="footer__social">
                <a target="blank" href="https://www.linkedin.com/in/noor-muhammed-a96a10116/" class="footer__icon"><i class='bx bxl-linkedin' ></i></a>
                <a target="blank" href="https://github.com/NOORMUHAMM" class="footer__icon"><i class='bx bxl-github' ></i></a>
                <a target="blank" href="https://twitter.com/noormuhammed143" class="footer__icon"><i class='bx bxl-twitter' ></i></a>
            </div>
